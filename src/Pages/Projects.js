            ...
            return(
                ...
                <img src={obj.thumb} className="img-responsive thumb" alt="placeHolder"></img>
                    <div className="btn-block-container">
                        <a className="btn btn-flex btn-success" href={obj.projectLink} target="_blank"><span className="fa fa-code"></span> Try me</a>
                        <a className="btn btn-flex btn-default" href={obj.codeLink} target="_blank"><span className="fa fa-code-fork"></span> See the code</a>
                    </div>
